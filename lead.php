...
$data_to_fb = ["action_source" => "website", "event_name" => "Lead", "event_time" => $data, "event_source_url" => urlencode($event_source_url) , "user_data" => ["external_id" => $external_id, "client_ip_address" => $client_ip_address, "client_user_agent" => $client_user_agent, "fbc" => $fbclid, "subscription_id" => $subscription_id, "fbp" => "fb.1." . $data . "." . $rand, "fn" => $firstname, "ln" => $lastname, "ph" => $phone, "ct" => $ct, "db" => $db, "st" => $st, "country" => $country, "em" => $em]];

$filename_cache = 'lead_cache.txt';
...
//    curl_setopt($ch, CURLOPT_HEADER, false);
    ...
    echo $html;
    curl_close($ch);
	$filename = 'lead_facebook_log.txt';
